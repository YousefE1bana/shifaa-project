...
This document contains the approved settled architecture, its reasoning, the immutable Constitution text, implementation sequence, SpecKit lifecycle, and the synchronized open-item register. It became the implementation baseline when Product Owner Yousef Osama approved v2.1.0 on 9-Aug-2026 and was amended to v2.1.1 on 25-Aug-2026 to close `OPEN-LEGAL-006` for Feature-007 specification/development. Artifact digests are recorded in the linked approval records. “Settled” means the team implements it unless a dated ADR and Product Owner approval amend it. Legal and clinical facts still require the evidence named in the compliance register.
