...
- Runtime: Node `24.18.0`, pnpm `11.13.0`, TypeScript `7.0.2`, Turbo `2.10.9`; the Expo app uses Expo-supported TypeScript `6.0.3`.
- Patient: Expo `57.0.11`, Expo Router `57.0.11`, React `19.2.3`, React Native `0.86.2`, Worklets `0.10.1`, web export.
