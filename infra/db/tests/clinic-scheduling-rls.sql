...
INSERT INTO clinical.schedules(id,facility_id,doctor_person_id,timezone_name,valid_from,valid_to,slot_duration_minutes,created_by_person_id,updated_by_person_id) VALUES ('f0090000-0000-4000-8200-000000000020','f0090000-0000-4000-8100-000000000003','f0090000-0000-4000-8a00-000000000002','Africa/Cairo','2030-01-01','2030-01-31',30,'f0090000-0000-4000-8a00-000000000001','f0090000-0000-4000-8a00-000000000001');
...
BEGIN
  ...
  PERFORM clinical.create_appointment_v1(jsonb_build_object('patient_person_id','f0090000-0000-4000-8b00-000000000002','facility_id','f0090000-0000-4000-8100-000000000003','doctor_person_id','f0090000-0000-4000-8a00-000000000002','schedule_id','f0090000-0000-4000-8200-000000000020','starts_at','2030-01-07T08:00:00Z','ends_at','2030-01-07T08:30:00Z','timezone_name','Africa/Cairo','civil_date','2030-01-07','local_start','10:00','fee_minor_units',10000,'currency_code','EGP')); RAISE EXCEPTION 'wrong patient was allowed to book';
...
BEGIN
  ...
  FOREACH projection IN ARRAY ARRAY[
    ...
    BEGIN
      PERFORM clinical.create_appointment_v1(jsonb_build_object('patient_person_id','f0090000-0000-4000-8a00-000000000003','facility_id',COALESCE(projection->>'facility_id','f0090000-0000-4000-8100-000000000003'),'doctor_person_id',COALESCE(projection->>'doctor_person_id','f0090000-0000-4000-8a00-000000000002'),'schedule_id','f0090000-0000-4000-8200-000000000020','starts_at','2030-01-07T07:00:00Z','ends_at','2030-01-07T07:30:00Z','timezone_name','Africa/Cairo','civil_date',COALESCE(projection->>'civil_date','2030-01-07'),'local_start','09:00','fee_minor_units',10000,'currency_code','EGP'));
  ...
  BEGIN PERFORM clinical.create_appointment_v1(jsonb_build_object('patient_person_id','f0090000-0000-4000-8a00-000000000003','facility_id','f0090000-0000-4000-8100-000000000003','doctor_person_id','f0090000-0000-4000-8a00-000000000002','schedule_id','f0090000-0000-4000-8200-000000000020','starts_at','2030-01-07T07:00:00Z','ends_at','2030-01-07T07:30:00Z','timezone_name','Africa/Cairo','civil_date','2030-01-07','local_start','10:00','fee_minor_units',10000,'currency_code','EGP')); RAISE EXCEPTION 'missing action accepted'; EXCEPTION WHEN SQLSTATE '42501' THEN NULL; END;
  PERFORM pg_catalog.set_config('shifaa.action','wrong.action',true);
  BEGIN PERFORM clinical.create_appointment_v1(jsonb_build_object('patient_person_id','f0090000-0000-4000-8a00-000000000003','facility_id','f0090000-0000-4000-8100-000000000003','doctor_person_id','f0090000-0000-4000-8a00-000000000002','schedule_id','f0090000-0000-4000-8200-000000000020','starts_at','2030-01-07T07:00:00Z','ends_at','2030-01-07T07:30:00Z','timezone_name','Africa/Cairo','civil_date','2030-01-07','local_start','10:00','fee_minor_units',10000,'currency_code','EGP')); RAISE EXCEPTION 'wrong action accepted'; EXCEPTION WHEN SQLSTATE '42501' THEN NULL; END;
  PERFORM pg_catalog.set_config('shifaa.action','appointment.manage',true); PERFORM pg_catalog.set_config('shifaa.aal','0',true);
  BEGIN PERFORM clinical.create_appointment_v1(jsonb_build_object('patient_person_id','f0090000-0000-4000-8a00-000000000003','facility_id','f0090000-0000-4000-8100-000000000003','doctor_person_id','f0090000-0000-4000-8a00-000000000002','schedule_id','f0090000-0000-4000-8200-000000000020','starts_at','2030-01-07T07:00:00Z','ends_at','2030-01-07T07:30:00Z','timezone_name','Africa/Cairo','civil_date','2030-01-07','local_start','10:00','fee_minor_units',10000,'currency_code','EGP')); RAISE EXCEPTION 'insufficient AAL accepted'; EXCEPTION WHEN SQLSTATE '42501' THEN NULL; END;
  PERFORM pg_catalog.set_config('shifaa.aal','1',true); PERFORM pg_catalog.set_config('shifaa.purposes','',true);
  BEGIN PERFORM clinical.create_appointment_v1(jsonb_build_object('patient_person_id','f0090000-0000-4000-8a00-000000000003','facility_id','f0090000-0000-4000-8100-000000000003','doctor_person_id','f0090000-0000-4000-8a00-000000000002','schedule_id','f0090000-0000-4000-8200-000000000020','starts_at','2030-01-07T07:00:00Z','ends_at','2030-01-07T07:30:00Z','timezone_name','Africa/Cairo','civil_date','2030-01-07','local_start','10:00','fee_minor_units',10000,'currency_code','EGP')); RAISE EXCEPTION 'missing purpose accepted'; EXCEPTION WHEN SQLSTATE '42501' THEN NULL; END;
...
BEGIN
  BEGIN PERFORM clinical.create_appointment_v1(jsonb_build_object('patient_person_id','f0090000-0000-4000-8a00-000000000003','facility_id','f0090000-0000-4000-8100-000000000003','doctor_person_id','f0090000-0000-4000-8a00-000000000002','schedule_id','f0090000-0000-4000-8200-000000000020','starts_at','2030-01-07T07:00:00Z','ends_at','2030-01-07T07:30:00Z','timezone_name','Africa/Cairo','civil_date','2030-01-07','local_start','10:00','fee_minor_units',10000,'currency_code','EGP')); RAISE EXCEPTION 'expired relationship accepted'; EXCEPTION WHEN SQLSTATE '42501' THEN NULL; END;
...
BEGIN
  BEGIN PERFORM clinical.create_appointment_v1(jsonb_build_object('patient_person_id','f0090000-0000-4000-8a00-000000000003','facility_id','f0090000-0000-4000-8100-000000000003','doctor_person_id','f0090000-0000-4000-8a00-000000000002','schedule_id','f0090000-0000-4000-8200-000000000020','starts_at','2030-01-07T07:00:00Z','ends_at','2030-01-07T07:30:00Z','timezone_name','Africa/Cairo','civil_date','2030-01-07','local_start','10:00','fee_minor_units',10000,'currency_code','EGP')); RAISE EXCEPTION 'revoked relationship accepted'; EXCEPTION WHEN SQLSTATE '42501' THEN NULL; END;
